...
%   Detailed explanation goes here
    ...
    for layer=1:numel(net.layers)
        if isfield(net.layers{1,layer},'weights')&&~isempty(net.layers{1,layer}.weights)
            ...
            if length(net.layers{1,layer}.weights)==2
                x=res(layer).x;
            ...
            net.layers{1,layer}.momentum{1}=opts.parameters.mom.*net.layers{1,layer}.momentum{1}-(1-opts.parameters.mom).*dzdw - opts.parameters.weightDecay * net.layers{1,layer}.weights{1};
            net.layers{1,layer}.weights{1}=net.layers{1,layer}.weights{1}+opts.parameters.lr*net.layers{1,layer}.momentum{1}./mom_factor;
            
            net.layers{1,layer}.momentum{2}=opts.parameters.mom.*net.layers{1,layer}.momentum{2}-(1-opts.parameters.mom).*dzdb;
